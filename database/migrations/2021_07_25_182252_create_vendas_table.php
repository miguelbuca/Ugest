...
class CreateVendasTable extends Migration {
	...
	public function up()
	{
		Schema::create('vendas', function(Blueprint $table)
		{
			...
			$table->integer('ven_art_id')->index('ven_art_id');
			...
			$table->timestamp('ven_data_venda')->default(DB::raw('CURRENT_TIMESTAMP'));
			$table->timestamp('ven_data_registrar')->default(DB::raw('CURRENT_TIMESTAMP'));
		});
	}
